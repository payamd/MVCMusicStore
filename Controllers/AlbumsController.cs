...
namespace MVCMusicStore.Controllers
{
    public class AlbumsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "AlbumID,AlbumName,ArtistID")] Album album)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "AlbumID,AlbumName,ArtistID")] Album album)
        {
            if (ModelState.IsValid)
            {
