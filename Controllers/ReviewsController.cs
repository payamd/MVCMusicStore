...
namespace MVCMusicStore.Controllers
{
    public class ReviewsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "ReviewID,Contents,ReviewrEmail,AlbumID")] Review review)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "ReviewID,Contents,ReviewrEmail,AlbumID")] Review review)
        {
            if (ModelState.IsValid)
            {
